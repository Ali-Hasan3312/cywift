...
const RiskDashboard = () => {
  ...
  return (
    <div className=" h-[cal(100% - 100px)] bg-gray-300 pt-8 pl-8 pb-4 flex gap-6 overflow-x-auto">
    
    
    <Sidebar />
        <div className=" -ml-3">
      <Navbar />
      <div className="flex items-center gap-8 -mt-2 max-md:flex-wrap max-sm:gap-2 max-sm:mt-0">
        ...
        <div>
        <div className=" h-[57vh] w-[22vw] bg-white mt-3 rounded-lg">
         ...
         <div className="flex items-center gap-[2px]">
           <div className=" h-[6vh] w-[3vw] bg-yellow-400 rounded flex items-center justify-center font-semibold">2</div>
           <div className=" h-[6vh] w-[3vw] bg-orange-400 rounded flex items-center justify-center font-semibold">1</div>
           <div className=" h-[6vh] w-[3vw] bg-orange-400 rounded flex items-center justify-center font-semibold">1</div>
           <div className=" h-[6vh] w-[3vw] bg-red-600 rounded flex items-center justify-center font-semibold">2</div>
           <div className=" h-[6vh] w-[3vw] bg-red-600 rounded flex items-center justify-center font-semibold">8</div>
          </div>
         </div>
         <div className="flex  mt-[2px] items-center gap-1 ml-6">
            <span className="px-3 text-[10px]">4</span>
         <div className="flex items-center gap-[2px]">
           <div className=" h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold">3</div>
           <div className=" h-[6vh] w-[3vw] bg-yellow-400 rounded flex items-center justify-center font-semibold">1</div>
           <div className=" h-[6vh] w-[3vw] bg-orange-400 rounded flex items-center justify-center font-semibold">1</div>
           <div className=" h-[6vh] w-[3vw] bg-orange-400 rounded flex items-center justify-center font-semibold">2</div>
           <div className=" h-[6vh] w-[3vw] bg-red-600 rounded flex items-center justify-center font-semibold">2</div>
          </div>
         </div>
         <div className="flex  mt-[2px] items-center gap-1 ml-6">
         ...
         <div className="flex items-center gap-[2px]">
           <div className=" h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold">2</div>
           <div className=" h-[6vh] w-[3vw] bg-yellow-400 rounded flex items-center justify-center font-semibold"></div>
           <div className=" h-[6vh] w-[3vw] bg-yellow-400 rounded flex items-center justify-center font-semibold">1</div>
           <div className=" h-[6vh] w-[3vw] bg-orange-400 rounded flex items-center justify-center font-semibold">1</div>
           <div className=" h-[6vh] w-[3vw] bg-orange-400 rounded flex items-center justify-center font-semibold">3</div>
          </div>
         </div>
         <div className="flex  mt-[2px] items-center gap-1 ml-6">
         ...
         <div className="flex items-center gap-[2px]">
           <div className="h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold">2</div>
           <div className="h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold">3</div>
           <div className="h-[6vh] w-[3vw] bg-yellow-400 rounded flex items-center justify-center font-semibold">3</div>
           <div className="h-[6vh] w-[3vw] bg-yellow-400 rounded flex items-center justify-center font-semibold">1</div>
           <div className="h-[6vh] w-[3vw] bg-orange-400 rounded flex items-center justify-center font-semibold"></div>
          </div>
         </div>
         <div className="flex  mt-[2px] items-center gap-1 ml-6">
         ...
         <div className="flex items-center gap-[2px] ml-[2px]">
           <div className="h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold">2</div>
           <div className="h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold">1</div>
           <div className="h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold"></div>
           <div className="h-[6vh] w-[3vw] bg-custom-green rounded flex items-center justify-center font-semibold">2</div>
           <div className="h-[6vh] w-[3vw] bg-yellow-400 rounded flex items-center justify-center font-semibold">1</div>
          </div>
         </div>
         ...
         <div className="flex items-center gap-[2px]">
           <div className="h-[6vh] w-[3vw] flex items-center justify-center text-[10px] -mt-1">1</div>
           <div className="h-[6vh] w-[3vw] flex items-center justify-center text-[10px] -mt-1">2</div>
           <div className="h-[6vh] w-[3vw] flex items-center justify-center text-[10px] -mt-1">3</div>
           <div className="h-[6vh] w-[3vw] flex items-center justify-center text-[10px] -mt-1">4</div>
           <div className="h-[6vh] w-[3vw] flex items-center justify-center text-[10px] -mt-1">5</div>
          </div>
         </div>
        </div>
        </div>
        <div className="h-[240px] w-[60vw] bg-white mt-3 rounded-lg">
